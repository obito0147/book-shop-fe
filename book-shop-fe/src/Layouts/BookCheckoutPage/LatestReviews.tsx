...
export const LatestReviews: React.FC<{ review: ReviewModel[], bookId: number | undefined, mobile: boolean }> = (props) => {
    return (
            ...
            <div className="col-sm-10 col-md-10">
                {props.review.length > 0 ?
                    <>
                        ...
                        <div className="m-3">
                            <Link type='button' className="btn main-color btn-md text-white" to="#">Reach all review.</Link>
                        </div>
                    </>
                    :
                    <div className="m-3">
